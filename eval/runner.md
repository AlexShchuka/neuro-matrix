...
Per-criterion 0/1 scores can be recorded in the `criterion_scores` column (comma-separated 16 digits) — enables Krippendorff α when ≥2 raters score the same (probe × calibration).
